  ...
  return (
    <main className="relative z-10 min-h-screen font-heading overflow-x-hidden">
      ...
      <div className="mx-auto max-w-6xl px-4 py-10 max-lg:py-8 max-md:px-3 max-md:py-6">
        ...
        {tracks.length === 0 ? (
        <div className="mt-8 max-lg:mt-6 max-md:mt-4 rounded-2xl border border-white/10 bg-white/[0.04] shadow-lg shadow-black/20 backdrop-blur-sm overflow-hidden flex flex-col min-h-[calc(70vh-160px)] max-lg:min-h-[calc(65vh-160px)] max-md:min-h-[calc(45vh-160px)]" aria-label="Pistes">
              <input
