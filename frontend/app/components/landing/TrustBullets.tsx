      ...
      <ObserveSection>
        <div className="mx-auto flex max-w-4xl flex-col gap-8 sm:flex-row sm:justify-between sm:gap-10">
          {items.map((item, i) => (
            ...
            >
              <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border border-white/15 bg-white/5 text-base text-slate-300 transition-all duration-300 group-hover:scale-105 group-hover:border-white/25 group-hover:bg-white/10 sm:mx-auto sm:mb-1 sm:flex">
                {item.icon}
              </span>
