...
export function ManageSubscriptionModal({
  ...
  const content = (
    <div className="modal-backdrop-slate fixed inset-0 z-[9999] flex items-center justify-center p-4 max-lg:p-3" onClick={onClose}>
      ...
      <div className="modal-panel-dark font-sans rounded-2xl border border-white/15 backdrop-blur-xl p-6 max-w-md w-full relative max-h-[90vh] overflow-y-auto max-lg:max-w-[calc(100vw-1.5rem)] max-lg:p-4 max-lg:rounded-xl max-lg:max-h-[85vh]" onClick={(e) => e.stopPropagation()}>
  ...
  const cancelConfirmModal = (
    <div className="modal-backdrop-slate fixed inset-0 z-[10000] flex items-center justify-center p-4" onClick={() => setShowCancelConfirm(false)}>
      <div className="backdrop-blur-layer" aria-hidden="true" />
      <div className="backdrop-tint-layer" aria-hidden="true" />
      <div className="modal-panel-dark font-sans rounded-2xl border border-white/15 backdrop-blur-xl p-6 max-w-sm w-full" onClick={(e) => e.stopPropagation()}>
