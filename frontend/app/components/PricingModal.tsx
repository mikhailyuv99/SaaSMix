...
export function PricingModal({
  ...
  return (
    <div className="modal-backdrop-slate fixed inset-0 z-[9999] flex items-center justify-center backdrop-blur-md p-4 max-lg:p-3 overflow-y-auto" onClick={onClose}>
      <div
