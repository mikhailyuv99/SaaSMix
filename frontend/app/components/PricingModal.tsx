                ...
                >
                  ...
                  <div className="mt-3 pt-3 shrink-0">
                    <button
                      ...
                      className={`w-full rounded-xl border px-4 py-2.5 text-center text-sm transition-colors uppercase max-md:py-2 max-md:text-xs disabled:opacity-50 disabled:cursor-not-allowed ${
