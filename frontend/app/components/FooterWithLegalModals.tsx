...
function LegalModalContent({ type }: { type: NonNullable<LegalModalType> }) {
  if (type === "mentions") {
    return (
      <>
        <h1 id="legal-modal-title" className="text-xl font-semibold text-white mb-4">Mentions légales</h1>
  ...
  if (type === "politique") {
    return (
      <>
        <h1 id="legal-modal-title" className="text-xl font-semibold text-white mb-4">Politique de confidentialité</h1>
        <div className="space-y-5 text-sm text-slate-400">
          <p>
  ...
  return (
    <>
      <h1 id="legal-modal-title" className="text-xl font-semibold text-white mb-4">Conditions générales d&apos;utilisation (CGU)</h1>
      <div className="space-y-5 text-sm text-slate-400">
        <p>
    ...
    <>
      <footer className="relative z-20 mt-auto py-6 px-4 max-lg:py-5 max-lg:px-3 max-md:py-4 max-md:px-3">
        <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-8 text-[11px] sm:text-xs text-slate-400 max-md:gap-2 max-md:text-[10px]">
          ...
          <button type="button" onClick={openMentions} className="transition-colors hover:text-white">
            Mentions légales
          </button>
          <button type="button" onClick={openPolitique} className="transition-colors hover:text-white">
      ...
      {legalModal && (
        <div
          className="fixed inset-0 z-[9999] flex items-center justify-center bg-slate-900/40 backdrop-blur-md p-4 max-lg:p-3"
          onClick={closeModal}
          aria-modal="true"
          role="dialog"
        ...
        >
          <div
            className="rounded-2xl border border-white/15 bg-black/10 backdrop-blur-xl shadow-xl shadow-black/20 p-6 max-w-2xl w-full max-h-[90vh] overflow-y-auto max-lg:max-w-[calc(100vw-1.5rem)] max-lg:p-4 max-lg:rounded-xl max-lg:max-h-[85vh]"
