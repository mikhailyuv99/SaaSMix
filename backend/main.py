...
async def track_mix(
    ...
    tone_low: int = Form(2, ge=1, le=3, description="Basses: 1=EQ1, 2=EQ2, 3=EQ3"),
    tone_mid: int = Form(2, ge=1, le=3, description="Mids: 1=EQ4, 2=EQ5, 3=EQ6"),
    tone_high: int = Form(2, ge=1, le=3, description="Aigus: 1=EQ7, 2=EQ8, 3=EQ9"),
