...
def get_vst_status():
    ...
    # Chaîne B : ordre = flux signal (Gate → Core → Reverb → Doubler → Robot) ; master = post, hors chaîne
    def _opt(name, var):
    ...
    return {
        ...
        "chain": {
            ...
            "core (VST3_PATH)": _info("Project1", VST3_PATH),
        ...
        "master (post, hors chaîne mix)": _info("master2", MASTER_PATH),
    }
